...
<div class = "row">
    <div class = "col-8">
        <br>
        <form action="CreateRoom.php" method="post" style="text-align: center;">
            <input class="btn btn-dark btn-lg" type="submit" value="新しい部屋を作る">
        </form>
    </div>  
    ...
    <div class = "col-4">
        <img src = "./img/sabu.jpg" class="img-fluid">
    </div>
