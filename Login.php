                ...
                <form action="LoginCheck.php" method="post" style="text-align: center;">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            <div class="form-floating">
                                <input type="password" name="pas" class="form-control" pattern="^[0-9A-Za-z]+$" value="" required inputmode="email" minlength="0" maxlength="20">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="d-grid gap-2">
                                ...
                                <input class="btn btn-outline-success text-dark btn-lg" type="submit" value="ログイン">
                            </div>
                        </div>
                        <!-- </div> -->
                        <a href="sinki.html">
